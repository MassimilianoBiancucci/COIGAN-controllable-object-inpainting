...
from COIGAN.utils.common_utils import check_and_warn_input_range
...
class PerceptualLoss(nn.Module):
    ...
    def __init__(self, normalize_inputs=True):
        ...
        Args:
            normalize_inputs: whether to normalize the inputs to the VGG network
        """
    ...
    def do_normalize_inputs(self, x):
        """
        Normalize the inputs to the VGG network.
    ...
    def partial_losses(self, input, target, mask=None):
        """
        Compute the partial losses for the input and target.
    ...
    def forward(self, input, target, mask=None):
        """
        Compute the perceptual loss for the input and target.
    ...
    def get_global_features(self, input):
        """
        Compute the global features for the input.
